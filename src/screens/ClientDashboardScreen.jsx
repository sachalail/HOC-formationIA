...
export default function ClientDashboardScreen({ trees = [], quests = [] }) {
  ...
  // 3. LOGIQUE KPI & CALCULS EN TEMPS RÉEL
  ...
  return (
    <div className="bg-white min-h-screen text-slate-800 antialiased selection:bg-amber-100">
      <div className="max-w-7xl mx-auto px-6 py-6 space-y-6">
        ...
        {currentSessionSafe && (
          <>
            {/* COMPTEURS ET INDICES DE PERFORMANCE (KPI) - BLANC & ACCENTS AMBRE */}
        ...
        {/* POP-UP DE SLIDE EXPORTABLE - AMBIANCE BLANC DOMINANT & ACCENTS AMBRE */}
        {activeKpiIndex !== null && (
